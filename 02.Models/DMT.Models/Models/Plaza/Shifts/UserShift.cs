        ...
        public DateTime? Begin
        {
            ...
            set
            {
                if (_Begin != value)
                {
                    _Begin = value;
                    // Raise event.
                    this.Raise(() => this.Begin);
                    this.Raise(() => this.BeginDateString);
                    this.Raise(() => this.BeginTimeString);
                    this.Raise(() => this.BeginDateTimeString);
                }
            }
        }
        /// <summary>
        ...
        public DateTime? End
        {
            ...
            set
            {
                if (_End != value)
                {
                    ...
                    // Raise event.
                    this.Raise(() => this.End);
                    this.Raise(() => this.EndDateString);
                    this.Raise(() => this.EndTimeString);
                    this.Raise(() => this.EndDateTimeString);
                }
            }
        }
        /// <summary>
